self.onmessage = function(e) {
    ...
    console.log("Worker O received:", { gameBoard, player, size, difficulty });
...
function getBestMove(board, player, size, difficulty) {
    ...
    // Example: Use minimax algorithm with alpha-beta pruning
    // This example just returns a random move for demonstration
...
function checkWin(board, player, size) {
    // Implement win-checking logic for rows, columns, and diagonals
    const winPatterns = [];
